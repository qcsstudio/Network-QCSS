...
| High | Generated editorial images could fail intermittently in production | Vercel runtime telemetry showed resource and advisory visual requests entering a missing Next image-optimizer module | Dynamic 1440 x 810 visual routes now bypass redundant optimization, with a browser regression check |
