...
for (const route of routes) {
  ...
  if (
    /QCS should sell|lead-ready knowledge base|problems people actually search for|problem buyers actually search for|buyer triggers|what the buyer should receive|deeper sales and support conversations|buyers actually use|visitors self-qualify|the website routes visitors|routes visitors|services brand|skills it sells|short answers for search and AI summaries|two high-intent posts|publishing cadence/i.test(
      bodyText
    )
  ) {
